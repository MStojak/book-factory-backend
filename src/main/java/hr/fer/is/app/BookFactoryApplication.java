...
public class BookFactoryApplication {
	...
	public BookFactoryApplication(Environment env) {
		this.env = env;
	}

	public static void main(String[] args) {
		SpringApplication app = new SpringApplication(BookFactoryApplication.class);
	...
	public void initApplication() {
		...
		if (
				activeProfiles.contains("dev") && activeProfiles.contains("cloud")
		) {
			log.error(
